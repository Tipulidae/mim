...
%\midrule
%hs-cTnT, median (IQR)                            & -     \\
%Minutes to hs-cTnT, median (IQR)                 & -     \\
%Days between ECGs, median (IQR)                  & -     \\
%\midrule
%\textbf{ECG} & \\
%\midrule
%Pathological diagnosis on ECG, \%                & -     \\
\bottomrule
\end{tabular}
\caption{Characteristics of excluded patients}
\medskip
\small
%n, number; MACE, Major Adverse Cardiovascular Event; std, standard deviation; IQR, inter quartile range; ED, Emergency Department; hs-cTnT, high sensitivity cardiac troponin T; pathological diagnosis according to Glasgow on index ECG; Disease history recorded up to 5 years prior to the study event.
