...
\begin{tikzpicture}[auto,>=stealth']
  ...
  \node[combo, minimum height=4em, below=1 of index_fx, align=center] (combiner) {Combiner};
  \node[classifier, below=1 of combiner, align=center, minimum height=3em] (clf) {Classifier};
