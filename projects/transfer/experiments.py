    ...
    PTA008_XRN50A_R100 = Experiment(
        ...
        model_kwargs={
            'from_xp': {
                ...
                'commit': '500501d1ac835719bfc7d3c8e47a2250f428ed56',
                'epoch': 51,
                'trainable': False,
            }
        },
    ...
    PTA090_RN2_R100 = Experiment(
        ...
        model_kwargs={
            'from_xp': {
                ...
                'commit': '52714ee9f67981ed223a448c4f54bb50a2e94578',
                'epoch': 66,
                'trainable': False,
                'final_layer_index': -2,
                'suffix': '_rn2',
...
class Source(Experiment, Enum):
    ...
    TEST = RN1_R100_SEX._replace(
        description='Testing if the GPU on morrison will crash'
    )
